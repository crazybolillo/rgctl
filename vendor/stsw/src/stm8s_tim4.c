...
/**
  * @brief  Enables or Disables the TIM4 Update selection.
...
/**
  * @brief  Configures the TIM4 selection to be generated by software.
  * @param   TIM4_EventSource specifies the selection source.
  * This parameter can be one of the following values:
