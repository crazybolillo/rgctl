...
/**
  * @brief  Enables or Disables the TIM3 Update selection.
...
/**
  * @brief  Configures the TIM3 selection to be generated by software.
  * @param   TIM3_EventSource specifies the selection source.
  * This parameter can be one of the following values:
