...
/**
  * @brief  Enables or Disables the TIM2 Update selection.
...
/**
  * @brief  Configures the TIM2 selection to be generated by software.
  * @param   TIM2_EventSource specifies the selection source.
  * This parameter can be one of the following values:
