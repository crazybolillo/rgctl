...
/**
  * @brief  Enables or Disables the TIM1 Update selection.
...
/**
  ...
  * - TIM1_PSCRELOADMODE_UPDATE: The Prescaler is loaded at the update selection.
  * @retval None
  */
...
/**
  * @brief  Selects the TIM1 peripheral Commutation selection.
  * @param   NewState new state of the Commutation selection.
  * This parameter can be ENABLE or DISABLE.
  * @retval None
  */
...
/**
  * @brief  Configures the TIM1 selection to be generated by software.
  * @param   TIM1_EventSource specifies the selection source.
  * This parameter can be one of the following values:
